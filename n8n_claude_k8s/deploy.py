...
REQUIRED_CREDENTIALS = [
    ...
    {
        "env_key": "K8S_API_CREDENTIAL_ID",
        "n8n_type": "httpHeaderAuth",
        "n8n_name": "K8s Job Launcher",
    },
]
...
def map_env_vars(workflow: dict, creds: dict) -> dict:
    ...
    """
    placeholders = {
        "K8S_API_URL_PLACEHOLDER": "K8S_API_URL",
        "K8S_NAMESPACE_PLACEHOLDER": "K8S_NAMESPACE",
        "CLAUDE_CODE_IMAGE_PLACEHOLDER": "CLAUDE_CODE_IMAGE",
...
def map_credentials(workflow: dict, creds: dict) -> tuple:
    ...
    credential_map = {
        ...
        ("httpHeaderAuth", "K8s Job Launcher"): creds.get("K8S_API_CREDENTIAL_ID"),
    }
